...
export default function Product() {
  ...
  return (
    <div>
      <Link to="/catalog" className="text-sm text-green-600 hover:underline mb-4 inline-block">&larr; Back to Catalog</Link>
        ...
        <div className="p-6 flex-1">
          ...
          <div className="mt-6">
            {product.stock_quantity > 0 ? (
              <p className="text-sm text-green-600 font-medium">{product.stock_quantity} in stock</p>
            ) : (
